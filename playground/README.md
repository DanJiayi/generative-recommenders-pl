...
[![Release](https://img.shields.io/github/v/release/DanJiayi/playground)](https://img.shields.io/github/v/release/DanJiayi/playground)
[![Build status](https://img.shields.io/github/actions/workflow/status/DanJiayi/playground/main.yml?branch=main)](https://github.com/DanJiayi/playground/actions/workflows/main.yml?query=branch%3Amain)
[![codecov](https://codecov.io/gh/DanJiayi/playground/branch/main/graph/badge.svg)](https://codecov.io/gh/DanJiayi/playground)
[![Commit activity](https://img.shields.io/github/commit-activity/m/DanJiayi/playground)](https://img.shields.io/github/commit-activity/m/DanJiayi/playground)
[![License](https://img.shields.io/github/license/DanJiayi/playground)](https://img.shields.io/github/license/DanJiayi/playground)

This is a template repository for Pytorch Lightning projects that use uv for their dependency management.

- **Github repository**: <https://github.com/DanJiayi/playground/>
- **Documentation** <https://DanJiayi.github.io/playground/>
...
git remote add origin git@github.com:DanJiayi/playground.git
...
- Add the API Token to your projects secrets with the name `PYPI_TOKEN` by visiting [this page](https://github.com/DanJiayi/playground/settings/secrets/actions/new).
- Create a [new release](https://github.com/DanJiayi/playground/releases/new) on Github.
